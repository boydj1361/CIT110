...
# f strings are like this: {variable:.2f} for decimal places
...
print("This vehicle costs $", price_per_mile * 75, "to drive 20 miles")
print("This vehicle costs $", price_per_mile * 500, "to drive 20 miles")
